...
export default {
  ...
  methods: {
    ...
    async getComponent() {
      await this.axios
        .get("setup-asset/v1/component/" + this.id, {
          headers: {
            Authorization: "Bearer " + this.access_token,
          },
        })
    ...
    async update() {
      ...
      formData.set("component_code", this.form.component_code);
      formData.set("component_name", this.form.component_name.toUpperCase());

      await this.axios
        .post("setup-asset/v1/update-component/" + this.id, formData, {
          headers: {
            Authorization: "Bearer " + this.access_token,
          },
        })
